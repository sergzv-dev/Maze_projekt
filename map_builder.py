...
class WorldBuilder:
    ...
    def build(cls, size_x, size_y, quests: list['Quest']):
        ...
        rooms_dict = cls.build_doors(rooms_dict)
        rooms_dict = cls.add_monsters(rooms_dict, monster_probability=0.25, loot_probability=0.33)
        rooms_dict = cls.add_boxes(rooms_dict, box_probability=0.33)
    ...
    @staticmethod
    def build_doors(rooms_dict: dict) -> dict:
    ...
    @staticmethod
    def add_monsters(rooms_dict, *, monster_probability=0.25, loot_probability=0.33) -> dict:
        for room in list(rooms_dict.values()):             # TODO
    ...
    @staticmethod
    def add_boxes(rooms_dict, *, box_probability=0.33) -> dict:
        from boxes import LootBox                       # TODO
        for room in list(rooms_dict.values()):                 # TODO
